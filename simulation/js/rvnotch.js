...
function magic() {
  if (simsubscreennum == 1) {
    ...
    document.getElementById("arrow1").style =
      "visibility:visible ;position:absolute; left: 350px; top: 180px; height: 50px; z-index: 10;";
    ...
    document.getElementById("arrow1").style =
      "visibility:visible ;position:absolute; left: 185px; top: 155px; height: 40px; z-index: 10;";
    ...
    document.getElementById("arrow1").style =
      "visibility:visible ;position:absolute; left: 160px; top: 290px; height: 50px; z-index: 10;";
